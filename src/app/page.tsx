      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:py-10 md:py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-5 sm:p-6 md:p-8 mb-6 sm:mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            <div className="border-l-4 border-blue-600 pl-3 sm:pl-4 hover:bg-blue-50 p-3 sm:p-4 rounded transition-colors">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-800">Audio Signal Processing</h3>
              </div>
            ...
            <div className="border-l-4 border-purple-600 pl-3 sm:pl-4 hover:bg-purple-50 p-3 sm:p-4 rounded transition-colors">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                </div>
                <h3 className="text-base sm:text-lg font-bold text-gray-800">Video Analysis</h3>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="border-l-4 border-orange-600 pl-3 sm:pl-4 hover:bg-orange-50 p-3 sm:p-4 rounded transition-colors sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg>
                </div>
                <h3 className="text-base sm:text-lg font-bold text-gray-800">Multimodal Fusion</h3>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:mmenoor@bu.ac.bd" className="text-blue-600 hover:text-blue-700 hover:underline text-sm sm:text-base break-all">
                    mmenoor@bu.ac.bd
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">Department of Computer Science &amp; Engineering</p>
                  <p className="text-gray-700 text-sm sm:text-base">University of Barishal</p>
                  <p className="text-gray-700 text-sm sm:text-base">Kornakathi, Barishal, Bangladesh</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium text-sm sm:text-base">Md Mahbub E Noor</p>
                  <p className="text-gray-700 text-xs sm:text-sm">Assistant Professor</p>
                </div>
              </div>
